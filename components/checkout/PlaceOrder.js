                ...
                <View style={{
                    ...
                    <View
                        ...
                        <View>
                            ...
                            <Text style={{ fontSize: 14, color: '#777777' }}>
                                {deliveryAddress.city}{", "}{deliveryAddress.state}{", "}{deliveryAddress.pincode}{", IN"}
                            </Text>
            ...
            <Pressable
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        {selectedPaymentMethod === 'pod' ? 'PAY ON DELIVERY / CASH ON DELIVERY' : selectedPaymentMethod === 'online' ? 'PAY ONLINE ( UPI, CARD)' : null}
                    </Text>
